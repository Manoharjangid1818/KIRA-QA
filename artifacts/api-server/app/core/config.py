...
The AI provider connection details are fully configurable so this service
can be pointed at a private Qwen3 deployment (or any other OpenAI-compatible
...
class Settings:
    ...
    # Auth — defaults to a dev-only secret. Override in production.
    jwt_secret: str = os.environ.get(
        "SESSION_SECRET", "kira-dev-secret-change-in-production"
    )
